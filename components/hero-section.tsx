                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Learn More About Our Goal</span>
                                        <span className="dark:border-background block h-4 w-0.5 border-l bg-white dark:bg-zinc-900"></span>
                                ...
                                <TextEffect
                                    ...
                                    speedSegment={0.3}
                                    as="h1"
                                    className="mt-8 text-balance text-7xl md:text-7xl lg:mt-10 xl:text-[7.25rem]">
                                    A Night of Praise
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    ...
                                    delay={0.5}
                                    as="p"
                                    className="mx-auto mt-6 max-w-2xl text-balance text-2xl">
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link href="#Pricing">
                                            <span className="text-nowrap">See our Ticket Pricing</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
